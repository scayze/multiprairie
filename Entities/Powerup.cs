...
namespace MultiplayerPrairieKing.Entities
{
    public class Powerup
	{
		...
		public void Draw(SpriteBatch b)
		{
			...
			{
				b.Draw(Game1.mouseCursors, topLeftScreenCoordinate + new Vector2(position.X, position.Y + yOffset), new Rectangle(272 + (int)type * 16, 1808, 16, 16), Color.White, 0f, Vector2.Zero, 3f, SpriteEffects.None, position.Y / 10000f + 0.001f);
			}
		}
	}
}
